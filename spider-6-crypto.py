...
def get_pages(id):
    url = "http://47.52.164.88/test4.php?id="+str(id)
    try:
...
def parse_response(response):
    ...
    classnum = base64.b64decode(data['classnum'])
    price = base64.b64decode(data['price'])
    print u"获取数据.....\n课程数量:",data['classnum'],u"课程价格:",data['price']
...
def main():
    for i in range(1,21):
        ...
        print u"课程id:",str(i),u"课程数量：",classnum,u"课程价格：",price
