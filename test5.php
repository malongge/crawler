    ...
    <div class="index-page">
		<div style="min-height: 350px">
			<div class="special-course-view" data-v-294d1676>
				...
				<h3 data-v-2c02addf>CSS隐藏元素不显示</h3>
				</div> 
		...
		<div class="xue-course-start__time" data-v-2c02addf><span class="course-all-num" data-v-2c02addf>共'.$classnum.'讲</span>
					...
					<div class="xue-course-start__course-price" data-v-2c02addf>
						<span class="discount-price" data-v-2c02addf>
						    优惠价:<span class="price-unit" data-v-2c02addf>￥</span><span class="price" data-v-2c02addf>';
    for($i=0;$i<$length;$i++){
       echo '<span>'.$price[$i].'</span>';
       $n=6-$price[$i];
       for($t=0;$t<$n;$t++){
          echo '<p style="display:none">'.$price[$i+1].'</p>' ;
       };
    };
echo '</span>
						</span>					
...
echo '				
<a href="test5.php?id='.$s.'">上一篇</a>
<a href="test5.php?id='.$x.'">下一篇</a>				
'
?>				
	
		
 <!----></div> <div class="footer" data-v-622986ff><div class="page-footer" data-v-622986ff><div class="foot" data-v-622986ff><span class="left" data-v-622986ff><span data-v-622986ff>多个标签，随机隐藏</span><br> <span data-v-622986ff>注册</span></span> <span class="right" data-v-622986ff><a href="/index/" data-xeslog-params="key=xeslog-index-touch&amp;action=click-index-touch&amp;click_id=3.11.1&amp;api_id=&amp;target_id=3.1.0" class="router-link-exact-active router-link-active" data-v-622986ff>首页</a>
        |
        |
    </div></div></div> <!----></div>
  </body>
