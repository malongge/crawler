    ...
    <div class="index-page">
		<div style="min-height: 350px">
			<div class="special-course-view" data-v-294d1676>
				...
				<h3 data-v-2c02addf>用于nginx配置演示</h3>
				</div> 
...
echo '				
<a href="test.php?id='.$s.'">上一篇</a>
<a href="test.php?id='.$x.'">下一篇</a>				
'
?>				
	
		
 <!----></div> <div class="footer" data-v-622986ff><div class="page-footer" data-v-622986ff><div class="foot" data-v-622986ff><span class="left" data-v-622986ff><span data-v-622986ff>登录</span> <span data-v-622986ff>注册</span></span> <span class="right" data-v-622986ff><a href="/index/" data-xeslog-params="key=xeslog-index-touch&amp;action=click-index-touch&amp;click_id=3.11.1&amp;api_id=&amp;target_id=3.1.0" class="router-link-exact-active router-link-active" data-v-622986ff>首页</a>
        |
    </div></div></div> <!----></div>
  </body>
</html>
