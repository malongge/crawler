...
$object = "11.png"; 
$expires = time()+10; 
$signed = urlencode(base64_encode(hash_hmac("sha1", $expires, $accessKeySecret, true))); 
$imgUrl= "/".$object."?Expires=".$expires."&Sign=".$signed; 
$my_img = "<img src=\"".$imgUrl."\" />"; 
echo $my_img; 
?>
							</span>
						</div> 
...
echo '				
<a href="test9.php?id='.$s.'">上一篇</a>
<a href="test9.php?id='.$x.'">下一篇</a>				
'
?>				
	
		
 <!----></div> <div class="footer" data-v-622986ff><div class="page-footer" data-v-622986ff><div class="foot" data-v-622986ff><span class="left" data-v-622986ff><span data-v-622986ff>以签名方式保护静态资源</span><br> <span data-v-622986ff>注册</span></span> <span class="right" data-v-622986ff><a href="/index/" data-xeslog-params="key=xeslog-index-touch&amp;action=click-index-touch&amp;click_id=3.11.1&amp;api_id=&amp;target_id=3.1.0" class="router-link-exact-active router-link-active" data-v-622986ff>首页</a>
        |
        |
    </div></div></div> <!----></div>
  </body>
