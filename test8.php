...
while( $row = mysqli_fetch_assoc( $result ) ) {
    ...
    ImageString($img_handle, 28, 10, 0, $price, $txt_color);//水平填充一行字符串
    Imagepng($img_handle,'price.png');
    imagedestroy($img_handle);
    // Feedback for end user
    echo '
		<div class="xue-course-start__time" data-v-2c02addf><span class="course-all-num" data-v-2c02addf>共'.$classnum.'讲</span></div> 
		<div class="xue-course-start__course-price" data-v-2c02addf>
		<span class="discount-price" data-v-2c02addf> 优惠价:￥</span><img style="vertical-align:middle" src="price.png">
                </div>				
	';
}
mysqli_close($mysqli);
...
echo '
<a href="test8.php?id='.$s.'">上一篇</a>
<a href="test8.php?id='.$x.'">下一篇</a>				
';
?>
	
		
 <!----></div> <div class="footer" data-v-622986ff><div class="page-footer" data-v-622986ff><div class="foot" data-v-622986ff><span class="left" data-v-622986ff><span data-v-622986ff>将敏感数据以图片方式展示</span><br> <span data-v-622986ff>注册</span></span> <span class="right" data-v-622986ff><a href="/index/" data-xeslog-params="key=xeslog-index-touch&amp;action=click-index-touch&amp;click_id=3.11.1&amp;api_id=&amp;target_id=3.1.0" class="router-link-exact-active router-link-active" data-v-622986ff>首页</a>
        |
        |
    </div></div></div> <!----></div>
  </body>
